...
public class Laser : TracerEntity
{
    public Dictionary<Ship, LaserTracer> Tracers = new();
    public Ship Ship;
    
    public Laser(MinkowskiVector origin, Ship ship)
    {
        Ship = ship;
...
public class LaserTracer : WorldlineEntity //todo: this does not need to be a WorldlineEntity
{
    public Ship? Ship;
    ...
    public LaserTracer(Ship? ship, Color color, Vector2 origin, float rotation)
    {
        Ship = ship;
        Origin = origin;
        Rotation = rotation;
